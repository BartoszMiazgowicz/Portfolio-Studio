    ...
    >
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          <FadeUp>
            <motion.div
              className="w-20 h-20 mx-auto mb-10 rounded-full bg-gradient-to-br from-amber-core/20 to-amber-deep/10 flex items-center justify-center"
            ...
            >
              <svg
                className="w-10 h-10 text-amber-core"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          {/* Subtext */}
          <FadeUp delay={0.4}>
            <p className="text-white-soft/60 text-lg md:text-xl font-light mb-12 max-w-2xl mx-auto">
          ...
          <FadeUp delay={0.6}>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <MagneticButton variant="primary" className="px-12 py-5 text-base" strength={0.3}>
                Start Your Project
              </MagneticButton>
              <MagneticButton variant="secondary" className="px-12 py-5 text-base" strength={0.3}>
                Schedule a Call
              </MagneticButton>
            </div>
          </FadeUp>
          ...
          {/* Contact Info */}
          <FadeUp delay={0.8}>
            <div className="mt-16 flex flex-col md:flex-row items-center justify-center gap-8 text-sm text-gray-muted">
              <a
              ...
              <span className="hidden md:block w-1 h-1 rounded-full bg-gray-muted" />
